...
// extractID handles various formats of SurrealDB IDs (string, map, struct)
func extractID(rowMap map[string]interface{}) string {
	...
	// Fallback
	return fmt.Sprintf("%v", rowMap["id"])
}
